...
@section('title', 'SI-MASE | Daftar Peserta Lulus')
                                                ...
                                                <form action="{{ route('skema.sertifikatLulus', ['id_skema' => $pengajuan->id_skema, 'id_users' => $pengajuan->user->id_users]) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="file" class="form-control" id="file_sertifikat" aria-describedby="file_sertifikat" name="file_sertifikat" accept=".jpeg, .jpg, .png, .pdf, .doc, .docx" required>
                                                        </div>
                                                    </div>
