            ...
            <div class="card-body">
                <form action="{{ route('kota-kabupaten.update', $kota_kabupaten->id_kota_kabupaten) }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="name" class="form-control @error('kode_kota_kabupaten') is-invalid @enderror" id="kode_kota_kabupaten" aria-describedby="kode_kota_kabupaten" value="{{ old('kode_kota_kabupaten', $kota_kabupaten->kode_kota_kabupaten) }}" name="kode_kota_kabupaten" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="name" class="form-control @error('nama_kota_kabupaten') is-invalid @enderror" id="nama_kota_kabupaten" aria-describedby="nama_kota_kabupaten" value="{{ old('nama_kota_kabupaten', $kota_kabupaten->nama_kota_kabupaten) }}" name="nama_kota_kabupaten" required>
