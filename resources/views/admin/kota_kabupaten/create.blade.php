            ...
            <div class="card-body">
                <form action="{{ route('kota-kabupaten.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="name" class="form-control" id="nama_kota_kabupaten" aria-describedby="nama_kota_kabupaten" value="{{ old('nama_kota_kabupaten') }}" name="nama_kota_kabupaten">
                    </div>
                    <div class="mb-3">
                        <label for="kode_kota_kabupaten" class="form-label">Kode Kota/Kabupaten</label>
                        <input type="name" class="form-control" id="kode_kota_kabupaten" aria-describedby="kode_kota_kabupaten" value="{{ old('kode_kota_kabupaten') }}" name="kode_kota_kabupaten">
                    </div>
                    <div class="row">
