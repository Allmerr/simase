...
@section('title', 'SI-MASE | Edit Satuan Kerja')
            ...
            <div class="card-body">
                <form action="{{ route('satker.update', $satker->id_satker) }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="name" class="form-control @error('nama') is-invalid @enderror" id="nama" aria-describedby="nama" value="{{ old('nama', $satker->nama) }}" name="nama" required>
                        @error('nama')
