...
@section('title', 'SIMASE | Pendidikan Kepolisian')

@section('content_header')
    <h1 class="m-0 text-dark">Pendidikan Kepolisian</h1>
@stop
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('pendidikan-kepolisian.create') }}" class="btn btn-primary mb-2">Create</a>
