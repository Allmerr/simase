            ...
            <div class="card-body">
                ...
                <form action="{{ route('peserta.revisiSkema', $pengajuan->id_skema) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('file_syarat_ijazah_terakhir') is-invalid @enderror" id="file_syarat_ijazah_terakhir" value="{{ old('file_syarat_ijazah_terakhir') }}" name="file_syarat_ijazah_terakhir" @if($pengajuan->status_file_syarat_ijazah_terakhir === 'ada disetujui')  disabled @endif @if($pengajuan->status_file_syarat_ijazah_terakhir != 'ada disetujui') required @endif>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">dokumen extensions yang diijinkan : .jpeg .jpg .png .pdf .docx</small>
                        <input type="file" class="form-control @error('file_syarat_sk_penempatan') is-invalid @enderror" id="file_syarat_sk_penempatan" value="{{ old('file_syarat_sk_penempatan') }}" name="file_syarat_sk_penempatan" @if($pengajuan->status_file_syarat_sk_penempatan === 'ada disetujui')  disabled @endif @if($pengajuan->status_file_syarat_sk_penempatan != 'ada disetujui') required @endif>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">dokumen extensions yang diijinkan : .jpeg .jpg .png .pdf .docx</small>
                        <input type="file" class="form-control @error('file_syarat_sk_sehat') is-invalid @enderror" id="file_syarat_sk_sehat" value="{{ old('file_syarat_sk_sehat') }}" name="file_syarat_sk_sehat" @if($pengajuan->status_file_syarat_sk_sehat === 'ada disetujui')  disabled @endif @if($pengajuan->status_file_syarat_sk_sehat != 'ada disetujui') required @endif>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">dokumen extensions yang diijinkan : .jpeg .jpg .png .pdf .docx</small>
                        <input type="file" class="form-control @error('file_syarat_nilai_e_rohani') is-invalid @enderror" id="file_syarat_nilai_e_rohani" value="{{ old('file_syarat_nilai_e_rohani') }}" name="file_syarat_nilai_e_rohani" @if($pengajuan->status_file_syarat_nilai_e_rohani === 'ada disetujui')  disabled @endif @if($pengajuan->status_file_syarat_nilai_e_rohani != 'ada disetujui') required @endif>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">dokumen extensions yang diijinkan : .jpeg .jpg .png .pdf .docx</small>
                        <input type="file" class="form-control @error('file_syarat_smk_skp_terakhir') is-invalid @enderror" id="file_syarat_smk_skp_terakhir" value="{{ old('file_syarat_smk_skp_terakhir') }}" name="file_syarat_smk_skp_terakhir" @if($pengajuan->status_file_syarat_smk_skp_terakhir === 'ada disetujui')  disabled @endif @if($pengajuan->status_file_syarat_smk_skp_terakhir != 'ada disetujui') required @endif>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">dokumen extensions yang diijinkan : .jpeg .jpg .png .pdf .docx</small>
                        <input type="file" class="form-control @error('file_syarat_cv') is-invalid @enderror" id="file_syarat_cv" value="{{ old('file_syarat_cv') }}" name="file_syarat_cv" @if($pengajuan->status_file_syarat_cv === 'ada disetujui')  disabled @endif @if($pengajuan->status_file_syarat_cv != 'ada disetujui') required @endif>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">dokumen extensions yang diijinkan : .jpeg .jpg .png .pdf .docx</small>
                        <input type="file" class="form-control @error('file_syarat_photo_3x4') is-invalid @enderror" id="file_syarat_photo_3x4" value="{{ old('file_syarat_photo_3x4') }}" name="file_syarat_photo_3x4" @if($pengajuan->status_file_syarat_photo_3x4 === 'ada disetujui')  disabled @endif @if($pengajuan->status_file_syarat_photo_3x4 != 'ada disetujui') required @endif>
